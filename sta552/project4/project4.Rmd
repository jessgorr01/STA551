...
When looking at this dataset, two areas we would want to explore through regression, SVMs, CART, Nueral Networks and Naive Bayes.
...
gnb.model <- naive_bayes(y ~ ., data = train)

# View the model summary: estimated means and variances for numeric features
gnb.model
```
